...
***Instructions (Applies to both Steam and non-Steam versions!)***
 
• Put `SaveRedirector_Steam.bat` and `SaveRedirector_Steam.ps1` next to the .exe of the game you'd like to use the script with
 
• Run `SaveRedirector_Steam.bat` to run the script - alternatively you can manually run `SaveRedirector.ps1` from a Powershell prompt
